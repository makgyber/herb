            ...
            <div class="col-md-6">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group form-group-sm row col-sm-12">
                                <label for="inputPassword" class="col-sm-5 control-label">Status</label>
                                <div class="col-sm-7">{{$reservation->status or ''}}
                                </div>
                            </div>
                            <div class="form-group form-group-sm row col-sm-12">
                            ...
                            <div class="form-group form-group-sm row col-sm-12">
                                <label for="pickupLocation" class="col-sm-5 control-label">Pickup Location</label>
                                <div class="col-sm-7">
